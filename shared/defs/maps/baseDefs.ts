...
export const Main: MapDef = {
    ...
    lootTable: {
        ...
        //     { name: "tier_airdrop_armor", count: 1, weight: 1 },
        //     { name: "tier_medical", count: 2, weight: 2 },
        //     { name: "tier_airdrop_scopes", count: 1, weight: 1 },
        //     { name: "tier_airdrop_outfits", count: 1, weight: 1 },
        //     { name: "tier_airdrop_melee", count: 1, weight: 1 },
        //     { name: "tier_airdrop_throwables", count: 1, weight: 1 }
        // ]

        // from the GPT: (removed m134)
        tier_scvadv: [
            { "name": "m9", "count": 1, "weight": 0.4 },
            { "name": "ots38_dual", "count": 1, "weight": 0.4 },
            { "name": "p30l_dual", "count": 1, "weight": 0.4 },
            { "name": "saiga", "count": 1, "weight": 0.4 },
            { "name": "deagle", "count": 1, "weight": 0.4 },
            { "name": "vector", "count": 1, "weight": 0.4 },
            { "name": "scorpion", "count": 1, "weight": 0.4 },
            { "name": "m4a1", "count": 1, "weight": 0.4 },
            { "name": "garand", "count": 1, "weight": 0.4 },
            { "name": "grozas", "count": 1, "weight": 0.4 },
            { "name": "flare_gun", "count": 1, "weight": 0.25 },
            { "name": "awc", "count": 1, "weight": 0.25 },
            { "name": "scarssr", "count": 1, "weight": 0.25 },
            { "name": "pkp", "count": 1, "weight": 0.25 },
            { "name": "m249", "count": 1, "weight": 0.25 },
            { "name": "sv98", "count": 1, "weight": 0.01 },
            { "name": "pan", "count": 1, "weight": 0.25 },
            { "name": "8xscope", "count": 1, "weight": 0.4 },
            { "name": "15xscope", "count": 1, "weight": 0.01 },
            { "name": "mirv", "count": 1, "weight": 0.4 },
            { "name": "outfitGhillie", "count": 1, "weight": 0.01 },
            { "name": "painkiller", "count": 1, "weight": 0.4 },
            { "name": "healthkit", "count": 1, "weight": 0.4 },
            { "name": "chest03", "count": 1, "weight": 0.4 },
            { "name": "helmet03", "count": 1, "weight": 0.4 },
            { "name": "backpack03", "count": 1, "weight": 0.4 }
        ]
    },
    mapGen: {
        map: {
